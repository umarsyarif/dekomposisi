                                        ...
                                        @if ($filter == null)
                                            @foreach ($uji as $row)
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="javascript:void(0)" class="jumlah" data-type="text" data-pk="{{$row->id}}" data-url="/api/uji/{{$row->id}}" data-name="jumlah" data-title="Jumlah Titik Api">{{$row->jumlah}}</a></td>
